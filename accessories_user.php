...
<div id="userfilterproduct">
	<form action="accessories_user.php" method="post" enctype="multipart/form-data">
...
<?php
	if (isset($_POST['filter']))
	{
		...
		$result = mysql_query("SELECT * FROM table_accessories WHERE product_name LIKE '%" .$productname. "%'");
		...
		while ($row = mysql_fetch_array($result)) 
		{
			...
			echo "<td>"."<img src='accessories/{$row['name_upload']}' style='width:300px; height:150px;'>"."</td>";
	...
	{
		$result = mysql_query("SELECT * FROM table_accessories");
		echo "<table class='table table-bordered table-hover' style='width:100%; text-align:center;'>
