...
$user = $_SESSION['logged_inuser'];
		$result = mysql_query("SELECT * FROM table_message WHERE sendto = '".$user."'");
		...
		while ($row = mysql_fetch_array($result)) 
		{
			...
			echo "<td>".$row['date']."</td>";
			echo "<td>".'<a href="msguserdelete.php?id='.$row['id'].'">Delete</a>'. "/" .'<a href="user_reply.php?costumer='.$row['username'].'">Reply</a>'."</td";
