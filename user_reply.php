...
Send To: <input type="text" value=<?php echo $_GET['costumer']; ?> disabled>
	<textarea name="text" style="width:100%; height:100%; resize:none;"> </textarea>
	...
	if (isset($_POST['submit'])) 
	{
		...
		$user = $_SESSION['logged_inuser'];
								...
								mysql_query("INSERT INTO table_message(username,date,time,message,sendto)
									VALUES
								('$user','$date','$time','$txt','$customer')");
		
				echo'<script>';
				echo 'alert("Send Successful");';
				echo 'location.href="user_mail.php"';
				echo'</script>';
	}
