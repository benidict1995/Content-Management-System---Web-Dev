...
<body>
<!--<a href='#top' id='toTop'><span class='glyphicon glyphicon-arrow-up'></span></a>-->
...
<div id="filterproduct">
	<form action="Bags.php" method="post" enctype="multipart/form-data">
...
<?php
	if (isset($_POST['filter']))
	{
		...
		$result = mysql_query("SELECT * FROM table_bags WHERE product_name LIKE '%" .$productname. "%'");
		...
		while ($row = mysql_fetch_array($result)) 
		{
			...
			echo "<td>"."<img src='bags/{$row['name_upload']}' style='width:300px; height:150px;'>"."</td>";
	...
	{
		$result = mysql_query("SELECT * FROM table_bags");
		echo "<table class='table table-bordered table-hover' style='width:100%; text-align:center;'>
